...
- **Per-category statuses.** Each category owns its ordered status list (films: Vu / En cours / À voir; games: Terminé / En cours / Abandonné / À jouer...). Status ids are preserved across edits so tastes keep their status when a list is reordered or renamed.
